...
import org.apel.dest.dubbokeeper.ui.domain.AppConsumeInfo;
import org.apel.dest.dubbokeeper.ui.domain.AppProvideInfo;
import org.apel.dest.dubbokeeper.ui.domain.ConsumerInfo;
...
@Controller
@RequestMapping("/app")
public class DubboApplicationController {
     ...
     * @return
     */
    @RequestMapping("/{id}/consumer-apps")
     ...
     * @return
     */
    @RequestMapping("/{appName}/provides")
     ...
     * @return
     */
    @RequestMapping("/{appName}/consumes")
     ...
     * @return
     */
    @RequestMapping("/{appName}/consumers")
