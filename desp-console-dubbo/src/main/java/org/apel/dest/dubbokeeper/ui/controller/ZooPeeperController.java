...
import org.apel.dest.dubbokeeper.ui.domain.SpyZooNode;
import org.apel.dest.dubbokeeper.ui.domain.SpyZooResponse;
...
public class ZooPeeperController implements InitializingBean{
    ...
    @RequestMapping("/listZookeepers")
    public  @ResponseBody
    Collection<String> listZookeepers(){
    	return ZK_CLIENT_MAP.keySet();
    }
    
    @RequestMapping("/{zkConnect}/loadChildren")
    public @ResponseBody
