package org.apel.desp.dubbokeeper.storage;

import java.util.ArrayList;
import java.util.List;
import java.util.concurrent.TimeUnit;

import org.apel.desp.dubbokeeper.storage.disruptor.StatisticsEvent;
import org.apel.desp.dubbokeeper.storage.disruptor.StatisticsEventFactory;
import org.apel.desp.dubbokeeper.storage.disruptor.StatisticsProducer;
...
public abstract class AbstractApplicationStatisticsStorage implements EventHandler<StatisticsEvent> {
    ...
    public void onEvent(StatisticsEvent event, long sequence, boolean endOfBatch) throws Exception {
        ...
        if(System.currentTimeMillis()-lastWrite>WRITE_INTERVAL){
