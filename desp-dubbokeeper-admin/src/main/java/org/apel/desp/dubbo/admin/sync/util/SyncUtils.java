 ...
 * with Alibaba.com.
 */
package org.apel.desp.dubbo.admin.sync.util;
...
public class SyncUtils {
    ...
    public static org.apel.desp.dubbo.admin.domain.Override url2Override(Pair<Long, URL> pair) {
    	if (pair == null) {
    		return null;
    	}
        ...
        org.apel.desp.dubbo.admin.domain.Override o = new org.apel.desp.dubbo.admin.domain.Override();
        o.setId(id);
