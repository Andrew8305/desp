...
serviceProvider.controller("viewProvider",function($scope,$httpWrapper,$routeParams,$breadcrumb,$httpWrapper,$menu){
    ...
    $httpWrapper.post({url:"provider/"+$routeParams.id+"/provider-detail",success:function(data){
        $scope.provider=data;
...
serviceProvider.controller("editProvider",function($scope,$http,$routeParams,$breadcrumb,$dialog,$httpWrapper,$menu){
    ...
    $httpWrapper.post({
        url:"provider/"+$routeParams.id+"/provider-detail",
...
serviceProvider.controller("serviceProviders",function($scope,$http,$routeParams,$queryFilter,$breadcrumb,$dialog,$httpWrapper,$menu){
    ...
    var requestUrl = "provider/"+encodeURIComponent($routeParams.serviceKey)+"/providers";
    if($routeParams.host){
        requestUrl="provider/"+$routeParams.application+"/"+$routeParams.host+"/providers";
    }
    ...
    $scope.operation=function(type,provider){
        var submit = function(){
            $httpWrapper.post({
                url:"provider/"+provider.id+"/"+type+"/operate",
                success:function(data){
    ...
    $scope.batchOperation=function(type){
        ...
        var submit=function(){
            $httpWrapper.post({
                url:"provider/"+type+"/batch-operate",
	...
	(function(){
        $httpWrapper.get({
            ...
            success:function(mdText){
            	$httpWrapper.post({
            		url:"provider/"+encodeURIComponent($routeParams.serviceKey)+"/service-readme",
                    success:function(data){
