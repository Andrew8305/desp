...
public class ProviderServiceImpl extends AbstractService implements ProviderService {
    ...
    public void updateProvider(Provider newProvider) {
        ...
        if(newProvider.isDynamic()){
            ...
            org.apel.desp.dubbo.admin.domain.Override override = generateDefaultOverride(newProvider);
            ...
            List<org.apel.desp.dubbo.admin.domain.Override> overrides = overrideService.listByProvider(oldProvider);
            URL editOverrideUrl = override.toUrl();
            for(org.apel.desp.dubbo.admin.domain.Override item:overrides){
    ...
    private org.apel.desp.dubbo.admin.domain.Override generateDefaultOverride(Provider provider){
